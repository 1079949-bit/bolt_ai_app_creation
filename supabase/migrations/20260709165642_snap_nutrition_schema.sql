...
INSERT INTO profiles (name, role, biography, image_url) VALUES
  ('Josiah', 'Lead Developer', 'Passionate about building health-focused applications that make a real difference in people''s lives. Loves clean code and innovative solutions.', 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg'),
  ('Yasmine', 'UI/UX Designer', 'Creative designer focused on making nutrition tracking beautiful and intuitive. Believes great design can inspire healthier choices.', NULL),
  ('Jaceorion', 'Health & Nutrition Specialist', 'Certified nutritionist and fitness enthusiast dedicated to making nutritional science accessible to everyone.', NULL)
