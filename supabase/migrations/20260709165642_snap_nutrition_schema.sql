...
INSERT INTO profiles (name, role, biography, image_url, github_username, interests, fun_fact, goal) VALUES
  ...
  ('Jaceorion', 'Health & Nutrition Specialist', 'Certified nutritionist and fitness enthusiast dedicated to making nutritional science accessible to everyone.', NULL, 'c6or3y', 'Music, fashion, food', 'Has been to NYC', 'Wants to perform at Rolling Loud')
