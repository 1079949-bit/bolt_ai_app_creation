...
import { ArrowLeft, Code, Palette, Github, Figma, Zap, Users, CheckCircle2, Trophy, Rocket } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        {/* My Progress Dashboard — Josiah only */}
        {profile.name === 'Josiah' && (
          <ProgressDashboard />
        )}
        ...
        {/* Role in App Section */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Role in App Creation</h2>
          <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
            <div className="w-14 h-14 bg-gradient-to-br from-primary-400 to-primary-600 rounded-xl flex items-center justify-center shadow-sm">
              <span className="text-2xl text-white">🌱</span>
            </div>
            <div>
              <p className="font-semibold text-gray-800">{profile.role}</p>
              <p className="text-sm text-gray-500">SnapNutrition Team Member</p>
            </div>
          </div>
        </div>
        ...
        {/* Quick Stats */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Team Stats</h2>
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center p-5 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
              <p className="text-3xl font-bold text-blue-500">2026</p>
            ...
            <div className="text-center p-5 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border border-amber-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Health Focused</p>
            </div>
          </div>
        </div>
      </div>
